  ...
  claim(
    ...
    [
      ...
      },
      {
        ...
        default: "ga",
        options: [
          { value: "ga", label: "General admission", hint: "Free", imagePlaceholder: true },
          { value: "vip", label: "VIP lounge", hint: "Invite only", locked: true, imagePlaceholder: true },
          { value: "speaker", label: "Speaker badge", hint: "Verified", locked: true, imagePlaceholder: true },
        ],
      },
