...
export const ICON_PATHS: Record<string, string[]> = {
  ...
  ticket: [
    "M4.5 8h15a1 1 0 0 1 1 1v1.5a1.5 1.5 0 0 0 0 3V14a1 1 0 0 1-1 1H4.5a1 1 0 0 1-1-1v-1.5a1.5 1.5 0 0 0 0-3V9a1 1 0 0 1 1-1Z",
    "M12 10v4",
  ],
  ...
  unlock: ["M9 11V8.2a3 3 0 0 1 6 0V11", "M6 11h12v8.5H6z", "M12 14.5v3"],
