...
export const ICON_PATHS: Record<string, string[]> = {
  ...
  ticket: ["M5 8.5h14a1.5 1.5 0 0 1 1.5 1.5v.5a1.5 1.5 0 0 0 0 3v.5A1.5 1.5 0 0 1 19 15.5H5A1.5 1.5 0 0 1 3.5 14v-.5a1.5 1.5 0 0 0 0-3V10A1.5 1.5 0 0 1 5 8.5Z", "M12.5 9.5v5"],
  ...
  unlock: ["M8 11V8.5a4 4 0 0 1 8 0V11", "M5 11h14v9H5z", "M11.5 14.5v2"],
