...
└── lib/
    ...
    ├── agent.ts             Anthropic loop + 8-tool toolbelt (…, draft_dapp_manifest, draft_variations, list_sparks, get_capabilities, resolve_ens_name, suggest_labels); returns {draft, drafts} for the variation picker; template fallback
